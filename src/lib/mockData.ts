...
export const alexCoverSvg = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="525" viewBox="0 0 1200 525"><defs><linearGradient id="cov_alex" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="%239EB7E5"/><stop offset="50%" stop-color="%23D6C7E5"/><stop offset="100%" stop-color="%23BCE7D0"/></linearGradient></defs><rect width="1200" height="525" fill="url(%23cov_alex)"/><circle cx="200" cy="380" r="190" fill="%23FFFFFF" fill-opacity="0.25"/><circle cx="950" cy="160" r="230" fill="%23FFFFFF" fill-opacity="0.2"/><path d="M0,460 Q300,300 600,380 T1200,320 L1200,525 L0,525 Z" fill="%23FFFFFF" fill-opacity="0.2"/></svg>`;
...
export const mishaCoverSvg = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="525" viewBox="0 0 1200 525"><defs><linearGradient id="cov_misha" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="%23D6C7E5"/><stop offset="50%" stop-color="%23FAD2B8"/><stop offset="100%" stop-color="%239EB7E5"/></linearGradient></defs><rect width="1200" height="525" fill="url(%23cov_misha)"/><path d="M100,270 C300,150 500,400 700,250 C900,100 1100,300 1200,210 L1200,525 L0,525 Z" fill="%23FFFFFF" fill-opacity="0.25"/><circle cx="600" cy="200" r="130" fill="%23FFFFFF" fill-opacity="0.2"/></svg>`;
...
export const annaCoverSvg = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="525" viewBox="0 0 1200 525"><defs><linearGradient id="cov_anna" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="%23BCE7D0"/><stop offset="50%" stop-color="%239EB7E5"/><stop offset="100%" stop-color="%23FAD2B8"/></linearGradient></defs><rect width="1200" height="525" fill="url(%23cov_anna)"/><circle cx="300" cy="200" r="170" fill="%23FFFFFF" fill-opacity="0.2"/><circle cx="850" cy="360" r="220" fill="%23FFFFFF" fill-opacity="0.25"/></svg>`;

export const peachCoverSvg = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="525" viewBox="0 0 1200 525"><defs><linearGradient id="cov_peach" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="%23FAD2B8"/><stop offset="50%" stop-color="%23F7B297"/><stop offset="100%" stop-color="%23D6C7E5"/></linearGradient></defs><rect width="1200" height="525" fill="url(%23cov_peach)"/><circle cx="250" cy="240" r="190" fill="%23FFFFFF" fill-opacity="0.2"/><path d="M0,400 Q350,220 700,350 T1200,280 L1200,525 L0,525 Z" fill="%23FFFFFF" fill-opacity="0.25"/></svg>`;
